from keras.layers import Conv2D, BatchNormalization, LeakyReLU, Add, MaxPooling2D, Dropout, concatenate, Conv2DTranspose
...
# Unet which uses and EfficientNetB4 128
...
def EfficientNet128(input_shape=(128, 128, 3), dropout_rate=0.5, normalization_data=None):
